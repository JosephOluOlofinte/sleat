                ...
                '>
                  <form action="" className='grid gap-[20px] xltablet:gap-[24px] lglaptop:gap-[30px]'>
                    ...
                    <div className='grid grid-rows-4 tablet:grid-rows-2 tablet:grid-cols-2 gap-[25px] xltablet:gap-[30px] lglaptop:gap-[40px]'>
                      ...
                      <input type="email" name="email" id="" placeholder="Enter your email" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white90 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>

                      <label htmlFor="phone" className="grid gap-[12px] lglaptop:gap-[16px]"><p className='pl-[10px]'>Phone Number</p>
                      <input type="text" name="phone" id="" placeholder="Enter your phone number" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white90 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>
                    </div>
                    ...
                    <div className='grid gap-[25px] xltablet:gap-[30px] lglaptop:gap-[40px]'>
                      ...
                      <input type="text" name="email-subject" id="" placeholder="Enter message subject" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white90 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>
                      
                      <label htmlFor="email-message" className="grid gap-[12px] lglaptop:gap-[16px]"><p className='pl-[10px]'>Message</p>
                      <textarea name="email-message" id="" placeholder="Enter your message" rows={5} className='resize-none w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white90 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>
                    </div>
