              ...
              grid grid-flow-row laptop:grid-flow-col laptop:grid-cols-[2fr_1px_1fr] gap-[16px] laptop:gap-[60px] lglaptop:gap-[80px]">
                ...
                '>
                  <form action="" className='grid gap-[20px] xltablet:gap-[24px] lglaptop:gap-[30px]'>
                    ...
                    <div className='grid grid-rows-4 tablet:grid-rows-2 tablet:grid-cols-2 gap-[25px] xltablet:gap-[30px] lglaptop:gap-[40px]'>
                      <label htmlFor="first-name" className="grid gap-[12px] lglaptop:gap-[16px]"><p className='pl-[10px]'>First name</p>
                      <input type="text" name="first-name" id="" placeholder="Enter first name" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white95 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>

                      <label htmlFor="last-name" className="grid gap-[12px] lglaptop:gap-[16px]"><p className='pl-[10px]'>Last name</p>
                      <input type="text" name="last-name" id="" placeholder="Enter last name" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white95 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>

                      <label htmlFor="email" className="grid gap-[12px] lglaptop:gap-[16px]"><p className='pl-[10px]'>Email </p>
                      <input type="email" name="email" id="" placeholder="Enter your email" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white95 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>

                      <label htmlFor="phone" className="grid gap-[12px] lglaptop:gap-[16px]"><p className='pl-[10px]'>Phone Number</p>
                      <input type="text" name="phone" id="" placeholder="Enter your phone number" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white95 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>
                    </div>
                    ...
                    <div className='grid gap-[25px] xltablet:gap-[30px] lglaptop:gap-[40px]'>
                      ...
                      <input type="text" name="email-subject" id="" placeholder="Enter message subject" className='w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white95 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>
                      
                      <label htmlFor="email-message" className="grid gap-[12px] lglaptop:gap-[16px]"><p className='pl-[10px]'>Message</p>
                      <textarea name="email-message" id="" placeholder="Enter your message" rows={5} className='resize-none w-full p-[16px] lglaptop:p-[20px] bg-white99 outline outline-1 outline-white95 rounded-lg laptop:rounded-lg text-grey40 placeholder-grey40 focus:outline-orange70' /></label>
                    </div>
