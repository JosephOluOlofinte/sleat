  ...
  return (
    <Fragment>
        <section className="min-h-[40vh] w-[100%] flex justify-center mt-[70px]">
            <div className="
            h-[100%] w-[90%] desktop:w-[80%] bg-absoluteWhite 
            p-[24px] xltablet:p-[50px] laptop:p-[70px] lglaptop:p-[90px] desktop:p-[110px] 
            grid grid-cols-1 laptop:grid-cols-3 
            gap-[40px] laptop:gap-[70px] lglaptop:gap-[100px]">
              ...
              <div className="rounded-2xl grid gap-[20px] h-max xltablet:min-w-[70%] laptop:col-span-2">
