...
const Accordion: React.FC<AccordionProps> = ({ title, description, withBtn, btnText = "", btnUrl, }) => {
  ...
  return (
    <div className={`h-max border-[1px] border-white95 rounded-[10px] px-[24px] xltablet:px-[40px] lglaptop:px-[50px] w-[100%] transition-all duration-700 ${
      ...
      '>
        ...
        <div className={`overflow-hidden transition-all  duration-[1s] ${
          isOpen ? "max-h-[450px]" : "max-h-0"
        }`}>
          <div className='border-t-[1px] border-white95 pt-[20px] laptop:pt-[40px] desktop:pt-[50px] mt-[24px] h-fit'>
